...
var DATA = {
  ...
  site: {
    ...
    backgroundVideo: '',                    // 배경 동영상 (mp4). 넣으면 사진 대신 재생됩니다
  ...
  theme: {
    ...
    infoGap: 13,          // 정보창 항목 사이 간격 (px)
    infoLine: 1.45,       // 정보창 줄 높이 (숫자가 클수록 위아래가 벌어집니다)
    bannerSeconds: 6,     // 배너가 몇 초마다 자동으로 넘어갈지 (0이면 안 넘어감)
    colors: {
  ...
  ticket: {
    ...
    seat: 'R석 B4 · B5',
    no:   'NO. 0907 — 2026',
    hint: '입장하면 음악이 재생됩니다'   // 티켓 맨 아래 안내 문구. 비우면 안 보입니다
  },
